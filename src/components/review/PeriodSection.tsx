...
const WaterIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 22c4.97 0 9-3.694 9-8.25 0-4.03-5.4-11.75-9-11.75S3 9.72 3 13.75c0 4.556 4.03 8.25 9 8.25z" />
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 16a3 3 0 100-6 3 3 0 000 6z" />
  </svg>
);
...
const GarageIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M13 16V6a1 1 0 00-1-1H4a1 1 0 00-1 1v9h1.5a2.5 2.5 0 015 0H15m1-3h2l3 3v4a1 1 0 01-1 1h-1a1 1 0 01-1-1v-1h-6v1a1 1 0 01-1 1h-1a1 1 0 01-1-1v-4l3-3z" />
  </svg>
);
    ...
    <div className="grid gap-6 md:grid-cols-2">
      <div className="md:col-span-2">
        ...
        <div className="mt-4  relative h-16 w-full">
            ...
            >
              <div className={`h-3 w-3 rounded-full ${isCurrentlyLiving ? 'bg-green-300' : 'bg-green-600'}`}></div>
              <div className={`mt-2 h-4 w-[1px] ${isCurrentlyLiving ? 'bg-green-300' : 'bg-green-600'}`}></div>
              <span className="mt-1 text-sm font-medium">{isCurrentlyLiving ? 'Actual' : endYear}</span>
            </div>
      ...
      <div className="md:col-span-2">
        ...
        <div className="mt-4 flex w-full justify-between">
          ...
          <div className="flex flex-col items-center">
            <div className={`relative flex h-8 w-8 items-center justify-center rounded-full ${periodData.included_services.includes('Luz') ? 'bg-green-100' : 'bg-gray-100'}`}>
              <LightIcon />
          ...
          {/* Agua */}
          <div className="flex flex-col items-center">
            <div className={`relative flex h-8 w-8 items-center justify-center rounded-full ${periodData.included_services.includes('Agua') ? 'bg-green-100' : 'bg-gray-100'}`}>
              <WaterIcon />
          ...
          {/* Comunidad */}
          <div className="flex flex-col items-center">
            <div className={`relative flex h-8 w-8 items-center justify-center rounded-full ${periodData.included_services.includes('Comunidad') ? 'bg-green-100' : 'bg-gray-100'}`}>
              <CommunityIcon />
          ...
          {/* Gas */}
          <div className="flex flex-col items-center">
            <div className={`relative flex h-8 w-8 items-center justify-center rounded-full ${periodData.included_services.includes('Gas') ? 'bg-green-100' : 'bg-gray-100'}`}>
              <GasIcon />
          ...
          {/* Garaje */}
          <div className="flex flex-col items-center">
            <div className={`relative flex h-8 w-8 items-center justify-center rounded-full ${periodData.included_services.includes('Garaje') ? 'bg-green-100' : 'bg-gray-100'}`}>
              <GarageIcon />
